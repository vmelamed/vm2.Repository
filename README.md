...
- Benchmarks (if included):
  ...
  ```bash
  dotnet run --project benchmarks/Repository.Benchmarks/Repository.Benchmarks.csproj --configuration Release
  ```
...
- Package ID: `vm2.Repository`
- Version: 0.0.0
- License: MIT
- Repository: <https://github.com/vmelamed/vm2.Repository>
...
- create GitHub repository using the generated bootstrap script: `scripts/setup-repo.sh`
